...
const { SingleResult } = require('../controllers/controller.agent');
...
router.get('/test-request/:id/result', useAsync(authMiddleware), useAsync(roleMiddleware(['farmer'])), useAsync(SingleResult));
